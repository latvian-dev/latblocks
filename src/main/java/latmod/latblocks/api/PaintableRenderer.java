...
public class PaintableRenderer
{
	...
	public static BlockRendererLM.BlockCustom currentParentBlock;
	
	public static Paint[] to6(Paint p)
	{ return new Paint[] {p, p, p, p, p, p}; }
	
	public static void renderCube(IBlockAccess iba, BlockRendererLM.RenderBlocksCustom rb, Paint[] p, BlockRendererLM.BlockCustom parent, int x, int y, int z, AxisAlignedBB aabb)
	{
		for(int i = 0; i < 6; i++)
		{
	...
	public static void renderFace(IBlockAccess iba, BlockRendererLM.RenderBlocksCustom rb, int s, Paint p, BlockRendererLM.BlockCustom parent, int x, int y, int z)
	{
		currentPaint = p;
